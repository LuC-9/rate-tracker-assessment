...
## Recording Status
The walkthrough recordings are stored directly in this repository:

- [Full walkthrough](walkthrough.webm)
- [Dashboard walkthrough](walkthrough-dashboard.webm)
- [Mobile walkthrough](walkthrough-mobile.webm)

These recordings cover the local review flow, dashboard interactions, API verification, and responsive/mobile behavior.
